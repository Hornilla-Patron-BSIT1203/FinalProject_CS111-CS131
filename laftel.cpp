//Hornilla , Angela L_BSIT1203
//Patron, Richina Faith M_BSIT1203
//Assessing Biodiversity through Plant Inventory: A Proposal for Management Planning.
//FINALPROJECT-CS11-CS131
//MAY 2023
            ...
            case 1:
                ...
                if (item == "Dragon Fruit") {
					...
					cout << "Empty the soil bag to the very environmentally friendly " << endl
						 << "coconut pot. Don't forget to leave about a quarter of " << endl
						 << "an inch or so of empty space in between the surface of " << endl
						 << "the soil and rim of the pot to ensure proper growth. " << endl;
					cout <<"======================================================="<< endl;
					cout << "\t\t\t*Sow* " << endl;
					cout <<"======================================================="<< endl;
					cout << "Drop at least 3 seeds into the pot. Cover them lightly " << endl 
						 <<"with some soil at least 2-3 mm deep or just cover the " << endl 
						 <<"seeds with the thickness not exceeding its diameter." << endl 
						 <<"Water the pot very lightly to ensure good seed to" << endl 
						 <<"mix contact. " << endl;
					cout << endl;
					...
					cout << "Plant chayote 3 to 4 weeks after the last average "<< endl 
						 ...
						 << "reached at least 65F(18C). Chayote grows best "<< endl 
